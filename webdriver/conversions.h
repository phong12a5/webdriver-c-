#ifndef FDRIVER_CONVERSIONS_H
#define FDRIVER_CONVERSIONS_H
...
public:
	...
	T Get(const std::string& name) const {
		...
		FDRIVER_CHECK(it != map.end(), detail::Fmt() << "No \"" << name << "\" in JsonObject");
...
void FromJsonImpl(const picojson::value& value, T& result, IterableTag) {
	FDRIVER_CHECK(value.is<picojson::array>(), "Value is not an array");
...
void CustomFromJson(const picojson::value& value, int& result) {
	FDRIVER_CHECK(value.is<double>(), "Value is not a number");
...
void CustomFromJson(const picojson::value& value, Size& result) {
	FDRIVER_CHECK(value.is<picojson::object>(), "Size is not an object");
...
void CustomFromJson(const picojson::value& value, Point& result) {
	FDRIVER_CHECK(value.is<picojson::object>(), "Point is not an object");
...
void CustomFromJson(const picojson::value& value, Cookie& result) {
	FDRIVER_CHECK(value.is<picojson::object>(), "Cookie is not an object");

...
class FDRIVER_EXPORT Session { // copyable
public:
    ...
    FDRIVER_EXPORT Element FindElement(const By& by) const;
    FDRIVER_EXPORT std::vector<Element> FindElements(const By& by) const;
